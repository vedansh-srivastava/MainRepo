...
<html lang="en" dir="ltr">
  ...
  <body style="background: linear-gradient(60deg,#11698e 0%, #19456b 100%  );">
...
<form class="form" onsubmit="return false" autocomplete="off">
  <div class="form-inner">
    <center><h2 style="color:#5748b2;" >Welcome!</h2></center>
    <center><h3 style="color:#5748b2;" >Enter your login credentials</h3></center>
    ...
    <div class="button-group">
      <button class="bsk btn--primary--mod btn--text--mod">Sign In</button>
    </div>
